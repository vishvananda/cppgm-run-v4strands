...
FRONTEND_OBJ_BASENAMES_pptoken := preprocess/pp_tokenizer
FRONTEND_OBJ_BASENAMES_posttoken := preprocess/pp_tokenizer
FRONTEND_OBJ_BASENAMES_ppexpr := preprocess/pp_tokenizer pa3_expression
